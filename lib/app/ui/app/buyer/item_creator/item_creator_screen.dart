...
import '../../common/message_detail/message_detail_screen.dart';
import '../../widgets/my_app_bar.dart';
import '../../widgets/plant_temperature.dart';

class ItemCreatorScreen extends GetView<ItemCreatorController> {
  ...
  _itemWidget(int index) {
    return GestureDetector(
      onTap: () {
        Get.offNamed(Routes.BUYER_ITEM_DETAIL, arguments: {
